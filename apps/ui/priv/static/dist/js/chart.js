...
// }
//
// window.updateChart = (labels, symbol, data) => {
//     if(["complete", "loaded", "interactive"].indexOf(document.readyState) >= 0){
//         doUpdate(labels, symbol, data)
//     }
// }
//
// let doRender = (labels, symbol, data) => {
...
// }
//
// let doUpdate = (labels, symbol, data) => {
//     window.chart.data.labels = labels;
//     window.chart.data.datasets.label = symbol;
//     window.chart.data.datasets.data = data;
//     console.log(labels);
//     window.chart.update();
// }
//
